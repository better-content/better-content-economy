...
public final class SpiritAcquiredEvent extends Event {
    private final ServerPlayer player;
    private final ResourceLocation spiritId;
    private final int count;
    private final UUID spiritEntityUuid;

    public SpiritAcquiredEvent(ServerPlayer player, ResourceLocation spiritId, int count, UUID spiritEntityUuid) {
        this.player = player;
